    ...
    <div class="appbox">
        <div class="wrapper">
            ...
            <div class="d-flex align-center justify-center">
                <form>
                    <v-text-field class="field" v-model="name" :error-messages="nameErrors" label="Nazwa użytkownika" required @input="$v.name.$touch()" @blur="$v.name.$touch()" autocomplete="off"></v-text-field>
                    <v-text-field class="field" type="password" v-model="password" :error-messages="passwordErrors" label="Hasło" required @input="$v.password.$touch()" @blur="$v.password.$touch()" autocomplete="off"></v-text-field>
                    ...
                    <v-btn rounded color="primary" v-if="checkAllField" class="mr-4" @click.prevent="submit" disabled>Zaloguj</v-btn>
                    <v-btn rounded color="primary" v-else class="mr-4" @click.prevent="submit">Zaloguj</v-btn>
