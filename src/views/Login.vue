    ...
    <div class="appbox">
        <div class="wrapper">
            ...
            <div class="d-flex align-center justify-center">
                <form>
                    <v-text-field v-model="name" :error-messages="nameErrors" label="Nazwa użytkownika" required @input="$v.name.$touch()" @blur="$v.name.$touch()" autocomplete="off"></v-text-field>
                    <v-text-field type="password" v-model="password" :error-messages="passwordErrors" label="Hasło" required @input="$v.password.$touch()" @blur="$v.password.$touch()" autocomplete="off"></v-text-field>
